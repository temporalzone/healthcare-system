...
# Email configuration — uses SMTP when credentials are provided, console otherwise
...
# Automatically fall back to console backend when SMTP credentials are not configured
